...
_Debug.overlay = function()
	...
	old_set_color(R, G, B, 220)
	love.graphics.rectangle("fill", 0, 0, w, h)
	old_set_color(255, 255, 255)
	love.graphics.setFont(_Debug.Font)
	local count = 0
	local cutY = 0
